					...
					<div className="mt-5" style={{ maxWidth: "500px", width: "100%" }}>
						...
						<div className="flex flex-row justify-between items-center mt-5">
							...
							<p className="flex flex-row">
								...
								<span className="ml-3 text-base">{romantic.duration}</span>
							</p>
						</div>
						...
						<div className="flex flex-col md:flex-row justify-between ">
							<div className="flex flex-col mt-1">
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{romantic.activities[0]}</span>
								</p>
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{romantic.activities[1]}</span>
								</p>
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{romantic.activities[2]}</span>
								</p>
							</div>
							<div className="flex flex-col mt-2">
								<p className="flex flex-row">
									<span className="ml-3 text-base">{romantic.activities[3]}</span>
								</p>
								<p className="flex flex-row mt-2">
								...
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{romantic.activities[4]}</span>
								</p>
							</div>
						</div>
