	...
	return (
		<div className="mx-5 md:mx-10">
			<div className="flex mt-10 border-gray-200">
				<div className="flex flex-col lg:flex-row w-full justify-around items-center shadow-[0_0_20px_rgba(0,0,0,0.2) md:h-80">
					<img
						src={snow.image}
						alt=""
					...
					<div className="" style={{ maxWidth: "500px", width: "100%" }}>
						...
						<div className="flex flex-row justify-between items-center mt-5">
							...
							<p className="flex flex-row">
								...
								<span className="ml-3 text-base">{snow.duration}</span>
							</p>
						</div>
						...
						<div className="flex flex-col md:flex-row justify-between ">
							<div className="flex flex-col mt-1">
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{snow.activities[0]}</span>
								</p>
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{snow.activities[1]}</span>
								</p>
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{snow.activities[2]}</span>
								</p>
							</div>
							<div className="flex flex-col mt-2">
								<p className="flex flex-row">
									<span className="ml-3 text-base">{snow.activities[3]}</span>
								</p>
								<p className="flex flex-row mt-2">
								...
								<p className="flex flex-row mt-2">
									<span className="ml-3 text-base">{snow.activities[4]}</span>
								</p>
							</div>
						</div>
